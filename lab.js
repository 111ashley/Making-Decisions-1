...
} else if (temperature < 60) {console.log ("Wear a jacket and carry an umbrella") }
  else {
    console.log ("It is not raining, enojoy your day")
  }
...
for (let i=1 ; i<11 ; i++) {console.log ('log', i);}
////////// PROBLEM 7 //////////
